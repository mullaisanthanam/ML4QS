...
DATASET_FNAME = 'chapter2_result_new.csv'
...
train_X, test_X, train_y, test_y = prepare.split_single_dataset_regression_by_time(dataset, 'labelSitting', '2022-06-09 09:55:46.257562624',
#                                                                                   '2016-02-08 18:29:58','2016-02-08 18:29:59')
                                                                                   '2022-06-09 10:16:04.257562624', '2022-06-09 10:34:05.057562624')
...
dftest = adfuller(dataset['labelSitting'], autolag='AIC')

plt.Figure(); autocorrelation_plot(dataset['labelSitting'])
DataViz.save(plt)
plt.show()
