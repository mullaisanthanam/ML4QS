...
def main():
    ...
    if FLAGS.mode == 'frequency':
        ...
        dataset = FreqAbs.abstract_frequency(dataset, ['glasses_ACC_X'], ws, fs)
        # Spectral analysis.
        DataViz.plot_dataset(dataset, ['glasses_ACC_X_max_freq', 'glasses_ACC_X_freq_weighted', 'glasses_ACC_X_pse', 'label'], ['like', 'like', 'like', 'like'], ['line', 'line', 'line','points'])
        print("--- %s seconds ---" % (time.time() - start_time))
