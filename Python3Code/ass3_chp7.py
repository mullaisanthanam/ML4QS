...
DATASET_FNAME = 'ass3_chapter5_result.csv'
RESULT_FNAME = 'ass3_chapter7_classification_result.csv'
EXPORT_TREE_PATH = Path('./figures/ass3_ch7_classification/')
...
basic_features = ['glasses_ACC_X', 'glasses_ACC_Y', 'glasses_ACC_Z',
...
selected_features = ['glasses_ACC_X_temp_mean_ws_68','glasses_ACC_Y_temp_mean_ws_68','glasses_ACC_Y_temp_std_ws_68','pca_7_temp_std_ws_68',
                    'glasses_GYRO_Y_temp_std_ws_68', 'glasses_ACC_Y_freq_0.0_Hz_ws_22', 'glasses_ACC_X', 'glasses_ACC_Y', 'pca_3_temp_std_ws_68',
                    'glasses_ACC_X_pse', 'glasses_ACC_X_max_freq', 'glasses_ACC_Z_freq_0.826_Hz_ws_22', 'glasses_ACC_Y_freq_weighted', 'glasses_ACC_Z_freq_0.723_Hz_ws_22',
                    'glasses_ACC_Z_freq_weighted', 'glasses_GYRO_Y_freq_0.0_Hz_ws_22', 'glasses_ACC_Z_pse', 'glasses_GYRO_Z_max_freq','glasses_EOG_L', 'glasses_ACC_Y_freq_0.413_Hz_ws_22',
                    'glasses_GYRO_Y_freq_0.826_Hz_ws_22']
...
DataViz.plot_performances_classification(['NN', 'RF', 'DT'], feature_names, scores_over_all_algs)
